  ...
  <div className="bg-background border-b border-border/50 text-xs">
    <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6">
      <div className="flex items-center gap-2 text-muted-foreground">
        ...
        <span className="hidden sm:inline">24/7 erreichbar für Anfragen</span>
        <span className="sm:hidden">24/7 erreichbar</span>
      </div>
      <div className="flex items-center gap-4 text-muted-foreground">
        <a href="tel:+4900000000" className="flex items-center gap-1.5 transition-colors hover:text-primary">
          <Phone className="h-3 w-3" />
          <span className="hidden md:inline">+49 (0) 000 000 000</span>
        </a>
