...
export const services: ServiceData[] = [
  {
    ...
    h1: "Objektschutz – Bewachung von Gebäuden und Betriebsstätten",
    metaTitle: "Objektschutz – Sentinel Services",
    metaDescription: "Objektschutz mit Zugangskontrolle, Schließdienst und dokumentierten Rundgängen. §34a, feste Einsatzleiter, abgestimmt auf Ihren Betriebsablauf.",
    faqs: [
  ...
  },
  {
    ...
    h1: "Veranstaltungsschutz – Security für Events und Firmenfeiern",
    metaTitle: "Veranstaltungsschutz – Sentinel Services",
    metaDescription: "Einlasskontrolle, Besucherlenkung, Deeskalation: Eventsecurity in Abstimmung mit Veranstalter und Ordnungsamt. Vom Firmenevent bis zur Großveranstaltung.",
    faqs: [
  ...
  },
  {
    ...
    h1: "Baustellenbewachung – Schutz für Material, Geräte und Zugänge",
    metaTitle: "Baustellenbewachung – Sentinel Services",
    metaDescription: "Baustellenschutz in Nacht- und Wochenendlage: Zufahrtskontrolle, Rundgänge, schnelle Meldekette bei Vorfällen. §34a-zertifiziertes Personal.",
    faqs: [
  ...
  },
  {
    ...
    h1: "Empfangs- und Pfortendienst für Unternehmen",
    metaTitle: "Empfangs- und Pfortendienst – Sentinel Services",
    metaDescription: "Besucher empfangen, Schlüssel verwalten, Anrufe entgegennehmen, Zutritt prüfen: Empfangsdienst, der zur Visitenkarte Ihres Hauses passt.",
    faqs: [
  ...
  },
  {
    ...
    h1: "Kontroll- und Streifendienst – Revierfahrten und Schließdienst",
    metaTitle: "Kontroll- und Streifendienst – Sentinel Services",
    metaDescription: "Geplante Revierfahrten, Alarmverfolgung und Schließrunden – wenn ein Objekt regelmäßige Präsenz braucht, aber keine durchgehende Besetzung.",
    faqs: [
  ...
  },
  {
    ...
    h1: "Individuelle Sicherheitskonzepte für komplexe Lagen",
    metaTitle: "Sicherheitskonzepte – Sentinel Services",
    metaDescription: "Risikoanalyse, Maßnahmenplan, Personalmodell, Reporting: ein Sicherheitskonzept, das wir mit Ihnen entwickeln und laufend nachjustieren.",
    faqs: [
